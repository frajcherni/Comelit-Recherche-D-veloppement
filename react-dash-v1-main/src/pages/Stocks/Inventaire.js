...
const QuantityFinalForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/GetTotalQteee', { code, startDate, placement: Placement });
        ...
        <div className="row">
          <div className="col-12">
            ...
            <form onSubmit={handleSubmit} className="row g-3 align-items-center">
              ...
              <div className="col-lg-4">
                <label className="form-label fw-bolder">Placement</label>
                <input className="form-control" type="text" value={Placement} onChange={(e) => setPlacement(e.target.value)} />
              </div>
