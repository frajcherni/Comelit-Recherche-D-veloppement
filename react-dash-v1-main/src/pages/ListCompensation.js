...
const LeaveRequests = ({ userId }) => {
  ...
  useEffect(() => {
    const fetchLeaveRequests = async () => {
      const res = await axios.get(`http://localhost:5000/getCompNonconge/${userId}`);
        ...
        <div className="confirm-toast">
          ...
          <div className="confirm-buttons">
            ...
            className='me-2'
              variant="primary"
              onClick={async () => {
                await axios.delete(`http://localhost:5000/CancelCompensation/${leaveId}`);
...
<div className="container">
    <div className="container my-2 px-2 py-4">
        <div className="row">
            ...
            <h1 className="display-7 fw-bolder mb-4 text-center text-black">Mes  <b>Compensation</b></h1> 
