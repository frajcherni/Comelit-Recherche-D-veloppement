...
useEffect(() => {
    ...
    const addUserdata = async (e) => {
        ...
        }else if (user.Scomposition === 0) {
          toast.warning("solde insuffisante", {
            position: "top-center"
          });
        } else if (date_debut === "") {
    ...
    <div className="container my-3 py-3">
        <div className="row">
            ...
            <h1 style={{ "fontFamily":"'Gill Sans', 'Gill Sans MT', 'Calibri', 'Trebuchet MS', sans-serif"}} className="display-6 text-center mb-4">Demande De Compensation</h1>
                <hr className="w-25 mx-auto"/>

                {user.Scomposition > 0 ? (
   <div className="alert alert-success mb-4 p-3 col-lg-3 fa fa-warning" role="alert">
      &nbsp; Solde Compensation : {user.Scomposition}
   </div>
) : (
